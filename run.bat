...
call ..\qemu\qemu-system-x86_64.exe -monitor stdio -smp 2 -m 1G -cpu Nehalem -drive format=raw,file=image.vhd -drive format=raw,file=bootable/image.vhd -soundhw pcspk
